...
.ossn-loading:not(:required) {
    -moz-animation: three-quarters-loader 0ms infinite linear;
    -webkit-animation: three-quarters-loader 0ms infinite linear;
    animation: three-quarters-loader 0ms infinite linear;
