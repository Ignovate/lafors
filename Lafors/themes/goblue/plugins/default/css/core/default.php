...
.ossn-layout-startup {
    min-height: 560px;
    background:url("<?php echo ossn_theme_url();?>images/background13.jpg") no-repeat;
...
.ossn-profile .profile-photo img {} .ossn-profile .user-fullname1 {
    color: #FFF;
    font-weight: bold;
    margin-top: -155px;
    font-size: 20px;
...
.ossn-loading:not(:required) {
	<!--background:url("</?php echo ossn_theme_url();?>images/Spinner.gif");
...
.coloum-left ossn-page-contents{
	width:102% !important;
}
@media only (min-width:312px) and (max-width:450px){
	.coloum-left ossn-page-contents{
	width:99% !important;
	.stud1{
		width:50%;
...
.btn1{
 border:none;background:none!important; outline:none;
}
.back1{
	background:url("<?php echo ossn_theme_url();?>images/student.jpg") no-repeat;
...
.group_name input{
 ...
 .search_banner{
	background:url("<?php echo ossn_theme_url();?>images/search_edited.jpg") no-repeat;
} 
.page_banner{
	background: #fff;
    padding: 10px;
...
.cssload-lt:before, .cssload-rt:before, .cssload-lb:before, .cssload-rb:before {
	...
	width: 20px;
	height: 20px;
	border-top: 3px solid rgb(199,64,102);
