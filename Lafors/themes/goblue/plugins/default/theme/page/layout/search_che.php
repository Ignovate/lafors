...
<br>
 <div class="row ">
	...
	<div class="col-md-2">
		...
		<div class="col-md-1 col-xs-6" id="s1">
	...
	<div class="row">
		 ...
		 <a href="#" value="ASearch" name="" class="color1" onclick="advsearch();" style="color: white;" id="ASearch">Advance Search&nbsp;<i class="fa fa-search" aria-hidden="true"></i></a>
		 </div>
		 <div class="col-md-3" >
		 </div>
	</div>
...
<div class="col-md-3">
	 ...
	 <select  id="willid" name="will[]" multiple="multiple">
		...
		/* }); */
		 ...
		 <div class="row">
	<div class="col-md-5 col-xs-6" id="s2" style="display:none;margin-left: 38%;margin-top:1%;margin-bottom:3%;">
<input type="submit" value="Search" style="margin-top: 3px;" class="btn btn-primary align1"  />
		</div>
		 <div class="col-md-2">
	</div>	
	</div>
