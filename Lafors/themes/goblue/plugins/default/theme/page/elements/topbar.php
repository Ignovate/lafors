	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-7 site-name text-center <?php echo $hide_loggedin;?>">
				...
				<a href="<?php echo ossn_site_url();?>"><img height="30px" src="<?php echo ossn_site_url('logo.png');?>" alt="Lafors Logo"/></a></span>
			</div>
			 
			<div class="col-md-3 text-right right-side">
				<div class="topbar-menu-right">
				     <li style="margin-top: 15px;">
					<a class="logo12" href="<?php echo ossn_site_url();?>"><img height="30px" style="margin-top: -9px;" src="<?php echo ossn_site_url('logo.png');?>" alt="Lafors Logo"/></a>
					</li>
