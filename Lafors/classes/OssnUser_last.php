...
class OssnUser extends OssnEntities {
		...
		public function getUserlist(){
				...
				$sql= $this->statement("SELECT DISTINCT profession FROM ossn_users where willing='yes'");
				$this->execute($sql);
				...
				$sql5= $this->statement("SELECT DISTINCT experience FROM ossn_users where willing='yes'");
				$this->execute($sql5);
				$contents['experience'] = $this->fetch(true);
				/* $sql6= $this->statement("SELECT DISTINCT expertise FROM ossn_users where willing='yes'");
				$this->execute($sql6);
				$contents['expertise'] = $this->fetch(true); */
				/* $sql7= $this->statement("SELECT DISTINCT designation FROM ossn_users where willing='yes'");
				$this->execute($sql7);
				$contents['designation'] = $this->fetch(true); */
				$sql8= $this->statement("SELECT DISTINCT organization FROM ossn_users where willing='yes'");
				$this->execute($sql8);
				$contents['organization'] = $this->fetch(true);
				/* $sql9= $this->statement("SELECT DISTINCT domain FROM ossn_users where willing='yes'");
				$this->execute($sql9);
				$contents['domain'] = $this->fetch(true); */
