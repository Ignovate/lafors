...
$en = array(
	'home' => 'Home',
	'site:index' => 'Welcome',
	'news:feed' => 'Lafors Wall',
	'new:feed' => 'Lafors Wall',
	'photos:ossn' => 'Gallery',
	'admin:view:site' => 'View Site',
	
	'home:top:heading' => "Welcome to %s! Join now to make new connects, create groups, add photos, and much more.",
...
%s",
	...
	'account:created:email' => "Your account has been registered! We have sent you an account activation email. If you didn't receive the email, please check your spam/junk folder",
        'password:error:matching' => "Password does not match.",
        'account:created:student' => "Your Account has been  Registered successfully! You can now Login into your account.",
	...
	'privacy:friends:note' => 'Only your connects can see this.',
	
	'add:friend' => 'Connect',
	'cancel:request' => 'Cancel Request',
	'remove:friend' => 'Disconnect',
	'no:friends' => 'No Connects',
	'settings' => 'Settings',
	'ossn:add:friend:error' => 'Cannot add connection!',
	'ossn:friend:request:submitted' => 'Your connection request has been sent!',
