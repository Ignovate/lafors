...
<label><?php echo ossn_print('group:category'); ?></label>
<select name="category">
<option value="">-select-</option>
<option value="Student"<?php echo ("Student" == $group->category)? 'selected': '' ?>>Student</option>
<option value="SME"<?php echo ("SME" == $group->category)? 'selected': '' ?>>SME</option>
<option value="Human Resource"<?php echo ("Human Resource" == $group->category)? 'selected': '' ?>>Human Resource</option>
<option value="Placement Officer"<?php echo ("Placement Officer" == $group->category)? 'selected': '' ?>>Placement Officer</option>
</select>
<br/>
