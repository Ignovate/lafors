           ...
           $query = input('q');
            ...
            echo ossn_view_page($title, $content);
			  ...
			  $title = ossn_print("search:result","Advance Search");
					  $contents['contents'] = ossn_call_hook('advancesearch', "type:{$type}", array('pro' =>input('pro'),'loc'=>input('loc'),'cors'=>input('cors'),'sub'=>input('sub'),'year'=>input('year'),'exp'=>input('exp'),'fun'=>input('fun'),'ind'=>input('ind'),'org'=>input('org'),'col'=>input('col'),'filter'=>input('filter')));
				  
				  $contents = array('content' => ossn_plugin_view('search/pages/search', $contents),);
			$contents['inputvalue']=array('pro' =>input('pro'),'loc'=>input('loc'),'cors'=>input('cors'),'sub'=>input('sub'),'year'=>input('year'),'exp'=>input('exp'),'fun'=>input('fun'),'ind'=>input('ind'),'des'=>input('des'),'org'=>input('org'),'col'=>input('col'),'filter'=>input('filter'));
			$users = new OssnUser;
