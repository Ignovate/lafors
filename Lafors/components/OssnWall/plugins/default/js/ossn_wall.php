        ...
        Ossn.ajaxRequest({
            ...
            callback: function(callback) {
                ...
                //need to clear file path after uploading the file #626
              	 ...
              	 var $wallphoto = $("#ossn-wall-form").find('#wallphoto');
                $wallphoto.replaceWith($wallphoto.val('').clone(true));
                $('#ossn-wall-photo').hide();
                 var $wallvideo = $("#ossn-wall-form").find('#wallvideo');
                $wallvideo.replaceWith($wallvideo.val('').clone(true));
                $('#ossn-wall-video').hide();
