...
function ossn_profile_load_event($event, $type, $params) {
		...
		ossn_register_menu_link('connects', 'friends', $owner->profileURL('/connects'), 'user_timeline');
	...
	//	print_r($params);
		...
		$data= $users->advanceSearch(array(
				// /* //'wheres' => "u.profession LIKE '%{$params['pro']}%'" */
				 'wheres' => "willing ='Yes' AND concat(u.profession LIKE '%{$params['pro']}%' or u.profession =null )AND concat(u.location LIKE '%{$params['loc']}%' or u.location=null) AND concat(u.course Like '%{$params['cors']}%' or u.course=null) AND concat(u.sub_course LIKE '%{$params['sub']}%' or u.sub_course=null) AND concat(u.yearcollege LIKE '%{$params['year']}%' or u.yearcollege=null) AND concat(u.experience LIKE '%{$params['exp']}%' or u.experience=null) AND concat(u.expertise LIKE '%{$params['expt']}%' or u.expertise=null) AND concat(u.organization LIKE '%{$params['org']}%' or u.organization=null) AND concat(u.domain LIKE '%{$params['dom']}%' or u.domain=null) AND concat(u.designation LIKE '%{$params['des']}%' or u.designation=null) AND concat(u.college LIKE '%{$params['col']}%' or u.college=null) And concat(concat(u.profession,'',u.location,'',u.course,'',u.email,'',u.mobile,'',u.username,'',u.first_name,'',u.last_name,'',u.college,'',u.designation,'',u.sub_course,'',u.experience,'',u.expertise,'',u.yearcollege,'',u.organization,'',u.domain)Like '%{$params['filter']}%' or concat(u.profession,'',u.location,'',u.course,'',u.email,'',u.mobile,'',u.username,'',u.first_name,'',u.last_name,'',u.college,'',u.designation,'',u.sub_course,'',u.experience,'',u.expertise,'',u.yearcollege,'',u.organization,'',u.domain)=null)"
		));
