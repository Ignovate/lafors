	...
	//	print_r($params);
		...
		$data= $users->advanceSearch(array(
				// /* //'wheres' => "u.profession LIKE '%{$params['pro']}%'" */
				 'wheres' => "willing ='Yes' AND concat(u.profession LIKE '%{$params['pro']}%' or u.profession =null )AND concat(u.state LIKE '%{$params['loc']}%' or u.state=null) AND concat(u.course Like '%{$params['cors']}%' or u.course=null) AND concat(u.sub_course LIKE '%{$params['sub']}%' or u.sub_course=null) AND concat(u.yearcollege LIKE '%{$params['year']}%' or u.yearcollege=null) AND concat(u.experience LIKE '%{$params['exp']}%' or u.experience=null) AND concat(u.functional LIKE '%{$params['fun']}%' or u.functional=null) AND concat(u.organization LIKE '%{$params['org']}%' or u.organization=null) AND concat(u.industry LIKE '%{$params['ind']}%' or u.industry=null) AND concat(u.designation LIKE '%{$params['des']}%' or u.designation=null) AND concat(u.college LIKE '%{$params['col']}%' or u.college=null) And concat(concat(u.profession,'',u.state,'',u.city,'',u.course,'',u.email,'',u.mobile,'',u.username,'',u.first_name,'',u.last_name,'',u.college,'',u.sub_course,'',u.experience,'',u.functional,'',u.yearcollege,'',u.organization,'',u.industry)Like '%{$params['filter']}%' or concat(u.profession,'',u.state,'',u.city,'',u.course,'',u.email,'',u.mobile,'',u.username,'',u.first_name,'',u.last_name,'',u.college,'',u.sub_course,'',u.experience,'',u.functional,'',u.yearcollege,'',u.organization,'',u.industry)=null)"
		));
		$count         = $users->advanceSearch(array(
				'wheres' => "willing ='Yes' AND concat(u.profession LIKE '%{$params['pro']}%' or u.profession =null)AND concat(u.state LIKE '%{$params['loc']}%' or u.state=null) AND concat(u.course LIKE '%{$params['cors']}%' or u.course=null) AND concat(u.sub_course LIKE '%{$params['sub']}%' or u.sub_course=null) AND concat(u.yearcollege LIKE '%{$params['year']}%' or u.yearcollege=null) AND concat(u.experience LIKE '%{$params['exp']}%' or u.experience=null) AND concat(u.functional LIKE '%{$params['fun']}%' or u.functional=null) AND concat(u.organization LIKE '%{$params['org']}%' or u.organization=null) AND concat(u.industry LIKE '%{$params['ind']}%' or u.industry=null) AND concat(u.college LIKE '%{$params['col']}%' or u.college=null) And concat(concat(u.profession,'',u.state,'',u.city,'',u.course,'',u.email,'',u.mobile,'',u.username,'',u.first_name,'',u.last_name,'',u.college,'',u.sub_course,'',u.experience,'',u.functional,'',u.yearcollege,'',u.organization,'',u.industry)Like '%{$params['filter']}%' or concat(u.profession,'',u.state,'',u.city,'',u.course,'',u.email,'',u.mobile,'',u.username,'',u.first_name,'',u.last_name,'',u.college,'',u.sub_course,'',u.experience,'',u.functional,'',u.yearcollege,'',u.organization,'',u.industry)=null) ",
				'count' => true
		));
   $user['users'] = $data;
		$search        = ossn_plugin_view('output/users', $user);
