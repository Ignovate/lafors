...
$user['willing'] = implode(',',input('willing'));
...
if(input('profession')=="SME" || input('profession')=="human resource" || input('profession')=="placement officer"){
...
if(input('profession')=="SME" || input('profession')=="human resource"){
	$user['mystory'] = input('mystory');	
}
$user['location'] = input('location');
