...
Ossn.NotificationBoxClose = function() {
    ...
    $('.ossn-notifications-box').find('.metadata').html('<div><div class="cssload-container"><div class="cssload-lt"></div><div class="cssload-rt"></div><div class="cssload-lb"></div><div class="cssload-rb"></div></div></div><div class="bottom-all"><a href="#">'+Ossn.Print('see:all')+'</a></div>');
